...
void main() => runApp(MaterialApp(
  ...
  home: switch (paso) {
    ...
    2 => Scaffold(
      body: ListView(
        children: [
          TarjetaLog(nivel: 'HOLA', componente: 'auth-service',
          ...
          TarjetaLog(nivel: 'VAMOS', componente: 'http-client',
              mensaje:   'GET /api/status → 200 OK (38ms)',
              timestamp: DateTime.now().subtract(const Duration(minutes: 8))),

           TarjetaLog(nivel: 'DO IT', componente: 'http-client',
    ...
    4 => const Scaffold(
      body: Center(
        child: Row(
          ...
          children: [
            AvatarBadge(nombre: 'web-01', alertas: 2,  activo: true, detalle: 'Es una prueba'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'db-01',  alertas: 0,  activo: true, detalle: 'Es una prueba'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'worker', alertas: 0,  activo: false, detalle: 'Es una prueba'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'cache',  alertas: 11, activo: true, detalle: 'Es una prueba'),

            SizedBox(width: 24),
            AvatarBadge(nombre: 'listo',  alertas: 11, activo: true, detalle: 'Es una prueba'),
          ],
        ),
      ),
    ),
  ...
  body: Center(
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        border:       Border(left: BorderSide(color: const Color.fromARGB(255, 226, 37, 154), width: 4)),
        boxShadow: [
          BoxShadow(
