...
class _RelojState extends State<Reloj> {
  ...
  Color get _colorTiempo {
    if (_segundos > 60) return const Color.fromARGB(255, 224, 18, 131);
    if (_segundos > 90) return Colors.orange;
    if (_segundos > 50) return const Color.fromARGB(255, 219, 223, 17);
    return Colors.green;
  }
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            TextButton(
              ...
              child: const Text('Registrar Vuelta con Funcion'),
            ),
        ...
        Text(
          ...
          style: TextStyle(fontSize: 12, color: const Color.fromARGB(255, 199, 29, 29)),
        ),
      ],
    );
  }
