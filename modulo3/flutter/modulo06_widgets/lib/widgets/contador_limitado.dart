...
class ContadorLimitado extends StatefulWidget {
  ...
  onLimite; // callback opcional — se llama al alcanzar el límite

  const ContadorLimitado({
    super.key,
    required this.etiqueta,
    this.limite = 1,
    this.color = const Color.fromARGB(255, 42, 155, 89),
    this.onLimite,
...
class _ContadorLimitadoState extends State<ContadorLimitado> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          widget.etiqueta, // ← widget.etiqueta
        ...
        LinearProgressIndicator(
          value: progreso,
          color: enLimite ? const Color.fromARGB(255, 201, 204, 12) : widget.color, // ← widget.color
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color: enLimite ? const Color.fromARGB(255, 149, 74, 219) : widget.color,
          ),
        ),
        ...
        if (enLimite)
          Text(
            'Límite alcanzado',
            style: TextStyle(fontSize: 12, color: const Color.fromARGB(255, 65, 82, 233)),
          ),
      ],
    );
  }
